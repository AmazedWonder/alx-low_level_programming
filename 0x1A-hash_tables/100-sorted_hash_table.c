...
/**
 * sorted_list - function inserts new node in sorted list
...
/**
 * shash_table_create - function creates a sorted hash tables
...
/**
 * shash_table_get - function retrieves value associeted with key
